...
mixer.init()
mixer.music.load(r"X:\Project\final\Audio.mp3")
...
send_button = tk.Button(root, text="Send Email", command=send_email_button, bg="red", fg="green", activeforeground="white", relief=tk.RAISED, font=("Comic Sans MS", 15, "bold"), width=10, height=3)
send_button.place(x=200, y=750)
